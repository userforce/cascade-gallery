...
__vue_render__._withStripped = true;
  ...
  var CascadeGalleryImage = normalizeComponent_1(
    ...
    methods: {
        ...
        prepareForNewImages() {
            console.log(this.newImagesStartIndex%this.columnsAmount > 0);
