...
__vue_render__$2._withStripped = true;
  ...
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-6d621534_0", { source: "\n.cascade-gallery-modal{\n}\n", map: {"version":3,"sources":["/home/vagrant/code/vue-pakajes/src/js/components/templates/Modal.vue"],"names":[],"mappings":";AAwCA;AAEA","file":"Modal.vue","sourcesContent":["<script>\r\n    import c from '../../constants';\r\n\r\n    export default {\r\n        name: c.GALLERY_COMPONENT_NAME,\r\n        props: {\r\n            images: { type: Array },\r\n            config: { type: Object }\r\n        },\r\n        data() {\r\n            return {\r\n                window: {\r\n                    width\r\n                }\r\n            };\r\n        },\r\n        mounted() {\r\n            this.window.width = window.innerWidth;\r\n            this.window.height = window.innerHeight;\r\n            window.onresize(this.resizeModal);\r\n            this.prepareModal();\r\n        },\r\n        methods: {\r\n            resizeModal(event) {\r\n                console.log(this.window.width);\r\n            },\r\n            prepareModal() {\r\n                console.log(this.window.width);\r\n            }\r\n        }\r\n    }\r\n</script>\r\n\r\n<template>\r\n    <div class=\"cascade-gallery-modal\">\r\n\r\n    </div>\r\n</template>\r\n\r\n<style>\r\n    .cascade-gallery-modal{\r\n\r\n    }\r\n</style>"]}, media: undefined });
